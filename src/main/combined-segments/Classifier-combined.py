# Prueba con campo emocion (combina activacion+valencia)
...
data_source = pd.read_csv('combined-test.csv')
...
# ==============================================================================
combined_test_model = MLPClassifier(
...
combined_test_model.fit(X=X_train, y=y_train)
file_route_1 = 'combined_test_model.pkl'
with open(file_route_1, 'wb') as model_file:
    pickle.dump(combined_test_model, model_file)

print('******************** Entrenamiento terminado. ***********************')

# ==============================================================================
accuracy_results = []
predictions = combined_test_model.predict(X=X_test)
