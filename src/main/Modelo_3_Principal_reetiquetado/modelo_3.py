...
data = pd.read_csv('C:\Tesis\Repositorio\mer-polca\src\main\Modelo_3_Principal_reetiquetado\modelo_3_descriptores.csv')
...
print(array)
labels = data.loc[:, 'emocion_principal'].dropna()
...
file_route_3 = 'modelo_3.pkl'
with open(file_route_3, 'wb') as model_file:
    pickle.dump(modelo_3, model_file)
