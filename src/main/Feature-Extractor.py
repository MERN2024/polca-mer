...
def extract_feature(path):
    ...
    for line in file_data:
        ...
        songname = path + line
        y, sr = librosa.load(songname, duration=900)
        ...
        songname_vector._set_value(song_id, line)  # song name
        tempo_vector._set_value(song_id, tempo)  # tempo
        total_beats._set_value(song_id, sum(beats))  # beats
        average_beats._set_value(song_id, np.average(beats))
        chroma_stft_mean._set_value(song_id, np.mean(chroma_stft))  # chroma stft
        chroma_stft_std._set_value(song_id, np.std(chroma_stft))
        chroma_stft_var._set_value(song_id, np.var(chroma_stft))
        chroma_cq_mean._set_value(song_id, np.mean(chroma_cq))  # chroma cq
        chroma_cq_std._set_value(song_id, np.std(chroma_cq))
        chroma_cq_var._set_value(song_id, np.var(chroma_cq))
        chroma_cens_mean._set_value(song_id, np.mean(chroma_cens))  # chroma cens
        chroma_cens_std._set_value(song_id, np.std(chroma_cens))
        chroma_cens_var._set_value(song_id, np.var(chroma_cens))
        mel_mean._set_value(song_id, np.mean(melspectrogram))  # melspectrogram
        mel_std._set_value(song_id, np.std(melspectrogram))
        mel_var._set_value(song_id, np.var(melspectrogram))
        mfcc_mean._set_value(song_id, np.mean(mfcc))  # mfcc
        mfcc_std._set_value(song_id, np.std(mfcc))
        mfcc_var._set_value(song_id, np.var(mfcc))
        mfcc_delta_mean._set_value(song_id, np.mean(mfcc_delta))  # mfcc delta
        mfcc_delta_std._set_value(song_id, np.std(mfcc_delta))
        mfcc_delta_var._set_value(song_id, np.var(mfcc_delta))
        cent_mean._set_value(song_id, np.mean(cent))  # cent
        cent_std._set_value(song_id, np.std(cent))
        cent_var._set_value(song_id, np.var(cent))
        spec_bw_mean._set_value(song_id, np.mean(spec_bw))  # spectral bandwidth
        spec_bw_std._set_value(song_id, np.std(spec_bw))
        spec_bw_var._set_value(song_id, np.var(spec_bw))
        contrast_mean._set_value(song_id, np.mean(contrast))  # contrast
        contrast_std._set_value(song_id, np.std(contrast))
        contrast_var._set_value(song_id, np.var(contrast))
        rolloff_mean._set_value(song_id, np.mean(rolloff))  # rolloff
        rolloff_std._set_value(song_id, np.std(rolloff))
        rolloff_var._set_value(song_id, np.var(rolloff))
        poly_mean._set_value(song_id, np.mean(poly_features))  # poly features
        poly_std._set_value(song_id, np.std(poly_features))
        poly_var._set_value(song_id, np.var(poly_features))
        tonnetz_mean._set_value(song_id, np.mean(tonnetz))  # tonnetz
        tonnetz_std._set_value(song_id, np.std(tonnetz))
        tonnetz_var._set_value(song_id, np.var(tonnetz))
        zcr_mean._set_value(song_id, np.mean(zcr))  # zero crossing rate
        zcr_std._set_value(song_id, np.std(zcr))
        zcr_var._set_value(song_id, np.var(zcr))
        harm_mean._set_value(song_id, np.mean(harmonic))  # harmonic
        harm_std._set_value(song_id, np.std(harmonic))
        harm_var._set_value(song_id, np.var(harmonic))
        perc_mean._set_value(song_id, np.mean(percussive))  # percussive
        perc_std._set_value(song_id, np.std(percussive))
        perc_var._set_value(song_id, np.var(percussive))
        frame_mean._set_value(song_id, np.mean(frames_to_time))  # frames
        frame_std._set_value(song_id, np.std(frames_to_time))
        frame_var._set_value(song_id, np.var(frames_to_time))
    ...
    feature_set.to_csv('Emotion_features_segmentos.csv')
    feature_set.to_json('Emotion_features_segmentos.json')


extract_feature('segmentos/')
