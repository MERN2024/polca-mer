# Prueba con emociones principales, reducido a 4 targets
...
data_source = pd.read_csv('4-targets-test.csv')
...
file_route_1 = 'test_model.pkl'
with open(file_route_1, 'wb') as model_file:
    pickle.dump(test_model, model_file)

print('******************** Entrenamiento terminado. ***********************')

# ==============================================================================
accuracy_results = []
predictions = test_model.predict(X=X_test)
accuracy_results.append(accuracy_score(predictions, y_test) * 100)
print('Puntuacion de precision modelo: ', accuracy_results)
