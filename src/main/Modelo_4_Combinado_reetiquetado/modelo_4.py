...
data = pd.read_csv('src\main\Modelo_4_Combinado_reetiquetado\modelo_4_descriptores.csv')
...
file_route_3 = 'modelo_4.pkl'
with open(file_route_3, 'wb') as model_file:
    pickle.dump(modelo_4, model_file)
...
# ==============================================================================
result = []
predicciones = modelo_4.predict(X = X_test)
