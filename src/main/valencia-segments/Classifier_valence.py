...
# ==============================================================================
data_source = pd.read_csv('valence-test.csv')
...
valence_test_model_1 = MLPRegressor(
...
valence_test_model_2 = MLPRegressor(
...
valence_test_model_3 = MLPRegressor(
    hidden_layer_sizes=(300, 125, 25, 5),
    learning_rate_init=0.01,
    solver='sgd',
    max_iter=1000,
...
valence_test_model_3.fit(X=X_train, y=y_train)
file_route_3 = 'valence_test_model_3.pkl'
with open(file_route_3, 'wb') as model_file:
    pickle.dump(valence_test_model_3, model_file)


valence_test_model_4 = RandomForestRegressor(
    n_estimators=100,
    random_state=42
)
valence_test_model_4.fit(X=X_train, y=y_train)
file_route_4 = 'valence_test_model_4.pkl'
with open(file_route_4, 'wb') as model_file:
    pickle.dump(valence_test_model_4, model_file)

print('******************** Entrenamiento terminado. ***********************')

# ==============================================================================
accuracy_results = []
predictions = valence_test_model_3.predict(X=X_test)
mse = mean_squared_error(y_test, predictions)
print("Error cuadrático medio modelo 3: {:.2f}".format(mse))
r2 = r2_score(y_test, predictions)
print("Error cuadrático r2 modelo 3: {:.2f}".format(r2))
accuracy_results.append(valence_test_model_3.score(X_test, y_test) * 100)
print('Puntuacion de precision modelo 3: ', accuracy_results)

accuracy_results = []
predictions = valence_test_model_4.predict(X=X_test)
mse = mean_squared_error(y_test, predictions)
print("Error cuadrático medio modelo 4: {:.2f}".format(mse))
accuracy_results.append(valence_test_model_4.score(X_test, y_test) * 100)
